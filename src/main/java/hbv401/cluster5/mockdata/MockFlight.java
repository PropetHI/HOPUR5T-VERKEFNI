...
/**
 * MockObject class to represent a placeholder for the Fight Service
 * @version 1.0
 * @author Hopur5T
 *
 */
public class MockFlight {
     ...
     */
    public MockFlight(int price, String aboutService, String location, int availableSpace, String id) {
        this.price = price;
